...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Download a Hugging Face dataset config to JSONL"
    )
    parser.add_argument(
        "--dataset",
        type=str,
        default="enelpol/rag-mini-bioasq",
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Dataset config name (e.g. question-answer-passages, text-corpus)",
    )
    parser.add_argument(
        "--out_dir",
        type=str,
